...
const CustomersSay = (props) => {
  return (
    <div className="customers-say-container" {...props}>
      ...
      <div className="customers-say-cards">
        ...
        <CustomersSayCard
          ...
          customerName="Bruno"
          testimonial="I have been to many restaurants, but this one certainly stood out. The quality of the ingredients and the preparation of the dishes were impeccable. Not to mention the presentation, which was beautiful."
        />
        <CustomersSayCard
          rating={5}
